...
namespace Komma\Tbai\Invoice;

use Komma\Tbai\Interfaces\TbaiXml;
use Komma\Tbai\Invoice\Breakdown\ForeignDeliveryNotSubjectBreakdownItem;
use Komma\Tbai\Invoice\Breakdown\ForeignDeliverySubjectExemptBreakdownItem;
use Komma\Tbai\Invoice\Breakdown\ForeignDeliverySubjectNotExemptBreakdownItem;
use Komma\Tbai\Invoice\Breakdown\ForeignServiceNotSubjectBreakdownItem;
use Komma\Tbai\Invoice\Breakdown\ForeignServiceSubjectExemptBreakdownItem;
use Komma\Tbai\Invoice\Breakdown\ForeignServiceSubjectNotExemptBreakdownItem;
use Komma\Tbai\Invoice\Breakdown\NationalNotSubjectBreakdownItem;
