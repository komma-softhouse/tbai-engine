...
namespace Test\Komma\Tbai\Api\Gipuzkoa;

use Komma\Tbai\Api;
use Komma\Tbai\Api\AbstractTerritory;
use Komma\Tbai\Api\Gipuzkoa\Endpoint;
...
class EndpointTest extends TestCase
{
    ...
    public function test_json_data_is_correct_on_sample(): void
    {
        ...
        $ticketbai = $this->ticketBaiMother->createGipuzkoaTicketBaiFromJson(
            __DIR__ . '/../../__files/tbai-sample.json'
        );
        $signedFilename = $this->signFile($ticketbai, $privateKey, $certPassword);
    ...
    private function getGipuzkoaP12Credentials(): array
    {
        return [
            PrivateKey::p12($_ENV['TBAI_GIPUZKOA_P12_PATH']),
            $_ENV['TBAI_GIPUZKOA_PRIVATE_KEY'],
        ];
    }
